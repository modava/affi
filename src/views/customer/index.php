                                        ...
                                        'columns' => [
                                            ...
                                            [
                                                ...
                                                'value' => function ($model) {
                                                    ...
                                                    return Html::a($model->partner->title, Url::toRoute(['/affiliate/partner/view', 'id' => $model->partner_id]),['style'=>$style]);
                                                }
                                            ],
                                            [
                                                'attribute' => 'birthday',
                                                ...
                                                'value' => function ($model) {
                                                    ...
                                                    $content .= "<strong>Nơi cấp: </strong>" . ($model->place_of_issue ? $model->provinceByPlace->name :'') . "<br/>";
                                                    $content .= "<strong>Ngày cấp: </strong>" . ($model->date_of_issue ? Yii::$app->formatter->asDate($model->date_of_issue): '') . "<br/>";
                                            ...
                                            [
                                                ...
                                                'value' => function ($model) {
                                                    $content = "<strong>Tổng tiền hoa hồng: </strong>" . Yii::$app->formatter->asCurrency($model->total_commission) . "<br/>";
                                                    $content .= "<strong>Tiền hoa hồng đã trả: </strong>" . Yii::$app->formatter->asCurrency($model->total_commission_paid) . "<br/><hr style='margin: 10px'>";
                                                    $content .= "<strong>Tiền hoa hồng còn lại: </strong>" . Yii::$app->formatter->asCurrency($model->total_commission_remain) . "<br/>";
                                                    return $content;
                                                }
                                            ],
                                            //'description:ntext',
