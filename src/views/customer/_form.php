...
$model->date_of_issue = Utils::convertDateTimeFromInt($model->date_of_issue);
...
<div class="customer-form">
    ...
    <section class="hk-sec-wrapper mb-3">
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-4">
                <?= $form->field($model, 'place_of_issue')->widget(\kartik\select2\Select2::class,[
                    'value' => $model->place_of_issue,
                    'initValueText' => $model->place_of_issue ? $model->place_of_issue : '',
                    'options' => ['placeholder' => Yii::t('backend', 'Chọn một giá trị ...')],
                    'pluginOptions' => [
                        'allowClear' => true,
                        'minimumInputLength' => 0,
                    ],
                    'data' => ArrayHelper::map(LocationProvinceTable::getProvinceByCountry($model->country_id,
