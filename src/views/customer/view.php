        ...
        <div class="hk-pg-header">
            ...
            <p>
                <?php if ($model->partner_id === PartnerSearch::getRecordBySlug('dashboard-myauris')->id) : ?>
                    <button class="btn btn-primary js-more-info btn-sm"
                            data-customer-id="<?= $model->partner_customer_id ?>"><?= Yii::t('backend', 'More Information') ?></button>
                <?php endif; ?>
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab"
                           href="#menu1"><?= Yii::t('backend', 'Tổng quan') ?></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab"
                           href="#list-order"><?= Yii::t('backend', 'DS Đơn sử dụng Coupon') ?></a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                        ...
                        <section class="hk-sec-wrapper">
                            <?= DetailView::widget([
                                ...
                                'attributes' => [
                                    ...
                                    'id_card_number',
                                    [
                                        'attribute' => 'place_of_issue',
                                        'value' => function ($model) {
                                            return $model->place_of_issue ? $model->provinceByPlace->name : '';
                                        }
                                    ],
                                    [
                                        'attribute' => 'date_of_issue',
                                        'value' => function ($model) {
                                            return $model->date_of_issue ? Yii::$app->formatter->asDate($model->date_of_issue) : '';
                                        }
                                    ],
                                    [
                    ...
                    <div class="tab-pane fade" id="list-order">
                        <section class="hk-sec-wrapper table-responsive">
                            ...
                            <?= GridView::widget(['pager' => ['firstPageLabel' => Yii::t('backend', 'First'),
                                ...
                                'columns' => [['attribute' => 'title',
                                    'format' => 'raw',
                                    'value' => function ($model) {
                                        return Html::a($model->title, ['order/view', 'id' => $model->id], ['title' => $model->title,
                                            'data-pjax' => 0,]);
                                    },
                                    ...
                                    ['attribute' => 'coupon_id',
                                        'format' => 'raw',
                                        'value' => function ($model) {
                                            return Html::a($model->coupon->coupon_code, Url::toRoute(['coupon/view', 'id' => $model->coupon_id]), ['data-pjax' => 0]);
                                        },
                                        'headerOptions' => ['class' => 'header-200',]],
                                    ['attribute' => 'status',
                                        'value' => function ($model) {
                                        ...
                                        'contentOptions' => ['class' => 'header-200']],
                                    'partner_order_code',
                                    'partner_customer_id',
