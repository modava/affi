                                ...
                                <div class="dataTables_wrapper dt-bootstrap4 table-responsive">
                                    ...
                                    ',
                                        ...
                                        'columns' => [
                                            ...
                                            [
                                                ...
                                                'visibleButtons' => [
                                                    ...
                                                    'delete' => function ($model) {
                                                        if (($model->quantity_used == 0 && strtotime($model->expired_date) < time()) || $model->count_sms_sent > 0)
                                                            return false;
                                                        return true;
                                                    },
                                                    'show-sms-coupon-content' => function ($model) {
                                                        if ($model->quantity_used == 0 && strtotime($model->expired_date) < time())
                                                            return false;
                                                        return true;
                                                    },
                                                    'send-sms-to-customer' => function ($model) {
                                                        if ($model->quantity_used == 0 && strtotime($model->expired_date) + 86399 < time())
                                                            return false;
                                                        return true;
                                                    },
                                                ],
                                            ...
                                            [
                                                ...
                                                'value' => function ($model) {
                                                    ...
                                                    $content = '<strong>Tên: </strong>' . ($model->customer_id ? Html::a($model->customer->full_name, Url::toRoute(['/affiliate/customer/view', 'id' => $model->customer_id]), ['style' => $style]) : '') . '<br/>';
                                                    $content .= '<strong>Đối tác: </strong>' . Html::a($model->customer->partner->title, Url::toRoute(['/affiliate/partner/view', 'id' => $model->customer->partner_id]), ['style' => $style]);
                                                    return $content;
                                                },
                                                'headerOptions' => [
                                                    'class' => 'header-200',
                                        ...
                                        'rowOptions' => function ($model) {
                                            if ($model->quantity_used == 0 && strtotime($model->expired_date)+23*60*60+59*60+59 < time()) {
                                                return
                                                    [
