...
use modava\affiliate\models\search\SmsLogSearch;
use yii\web\Response;

/**
 * SmsLogController implements the CRUD actions for SmsLog model.
 */
class SmsLogController extends MyController
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Lấy danh sách SMS theo khách hàng
     * @return string
     */
    public function actionGetSmsByCustomer()
    {
        Yii::$app->response->format = Response::FORMAT_JSON;
        $customerId = Yii::$app->request->get('customer_id');
        $models = SmsLog::find()->where('customer_id = :customer_id', [':customer_id' => $customerId])->all();
        return $this->renderAjax('mini-list', ['models' => $models]);
    }
