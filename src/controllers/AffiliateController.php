...
class AffiliateController extends \backend\components\MyController
{
    ...
    /**
     * Khởi tạo cache key cho parter *** Mỗi lần xóa cache hệ thống bắt buộc chạy khởi tạo lại cache key bằng cách gọi action này ***
     * @return array
     */
    ...
    /**
     * Lấy tổng feedback theo loại và thời gian
     * @return array
     * @throws \yii\db\Exception
     */
