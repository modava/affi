...
class CouponController extends MyController
{
    ...
    public function actionUpdate($id)
    {
        ...
        /*
         * Comment out by Duc Huynh 2020-12-11
    ...
    public function actionDelete($id)
    {
        ...
        if ($model->quantity_used > 0 || $model->count_sms_sent > 0) {
            Yii::$app->session->setFlash('toastr-' . $model->toastr_key . '-view', [
                'title' => 'Thông báo',
                'text' => 'Không thể xoá Coupon đã sử dụng hoặc đã gửi cho khách hàng',
                'type' => 'warning'
            ]);
            return $this->redirect(Url::toRoute(['view', 'id' => $id]));
        }
    ...
    /**
     * Khởi tạo mã code theo khách hàng crm.myauris.vn
     * @return array
     */
