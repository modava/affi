 ...
 *
 * @property int $id
 * @property string $message Nội dung SMS
 * @property string $to_number Số điện thoại gửi đến
 * @property int $customer_id Link đến Khách hàng
 * @property string $status Tình trạng
 * @property string $response_log response gửi về
 * @property string $request_log request gửi đi
