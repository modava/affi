...
use modava\affiliate\models\table\UnsatisfiedReasonTable;
...
/**
* This is the model class for table "affiliate_unsatisfied_reason".
*
    * @property int $id
    ...
    *
            * @property Feedback[] $affiliateFeedbacks
            * @property User $createdBy
            * @property User $updatedBy
    */
class UnsatisfiedReason extends UnsatisfiedReasonTable
{
    public $toastr_key = 'unsatisfied-reason';
