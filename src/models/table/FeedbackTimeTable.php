...
use cheatsheet\Time;
use modava\affiliate\models\query\FeedbackTimeQuery;
use Yii;
use yii\db\ActiveRecord;

class FeedbackTimeTable extends \yii\db\ActiveRecord
{
    const STATUS_DISABLED = 0;
    const STATUS_PUBLISHED = 1;
    const CACHE_KEY_GET_ALL = 'redis-affiliate-feedback-time-get-all';
    const CACHE_KEY_GET_ALL_ACTIVE = 'redis-affiliate-feedback-time-get-all-active';

    public static function tableName()
    {
        return 'affiliate_feedback_time';
    }

    public static function find()
    {
        return new FeedbackTimeQuery(get_called_class());
    }
