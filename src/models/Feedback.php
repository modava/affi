...
*
    ...
    *
            * @property Customer $customer Khách hàng
            * @property FeedbackTime $feedbackTime Thời gian feed back
            * @property UnsatisfiedReason $unsatisfiedReason Feedback không hài lòng
...
class Feedback extends FeedbackTable
{
    ...
    */
    ...
    /**
     * Đếm số lượng của feedback của khách hàng
     * @param $customerId
     * @return int
     */
    ...
    /**
     * Tính tổng Feedback Theo type và thời giam
     * @param $type
     * @return array
